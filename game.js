...
function draw() {
    ...
    ctx.fillStyle = "white";
    houses.forEach(house => ctx.fillRect(house.x, house.y, house.width, house.height));
    ...
    if (showMessage) {
        ...
        ctx.fillStyle = "white";
        ctx.font = "20px Arial";
        ctx.fillText("Hello Yianna, see that beautiful house there? Why not go inside and check it out?", 60, 100);
